...
Command: npx gltfjsx@6.5.3 python-transformed.glb -T 
Files: python-transformed.glb [5.15KB] > E:\portfolio\public\models\python-transformed-transformed.glb [5.12KB] (1%)
...
export function Model(props) {
  const { nodes, materials } = useGLTF('/python-transformed-transformed.glb')
  return (
...
useGLTF.preload('/python-transformed-transformed.glb')
